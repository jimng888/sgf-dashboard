...
4. Under **Encrypted variables** / **Secrets**, add:
   ...
   - **OPENCLAW_DASHBOARD_URL** = (optional) full URL of your OpenClaw dashboard if you run it elsewhere (e.g. https://openclaw.yourdomain.com). If unset, the status card shows "Dashboard is live" — “Set OPENCLAW_DASHBOARD_URL…” 
5. Save.
